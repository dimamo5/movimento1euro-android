...
public final class NavigationViewActions {
     ...
     *
     * <p> View constraints: <ul> <li>View must be a child of a {@link DrawerLayout} <li>View must be
     * of type {@link NavigationView} <li>View must be visible on screen <li>View must be displayed on
     * screen <ul>
     *
